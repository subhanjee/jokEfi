  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center   p-4 ">
      ...
      <div className=" ">
          ...
          <Image src={joke} alt="abc" width={350} height={350} className="relative z-50"/>
          <div className="flex gap-1">
          <Image className="mt-4 w-32 h-20 relative z-50" src={joke2} alt="abc" />
          <Image className="mt-4 w-58 h-20 relative z-50" src={joke1} alt="abc"  />
          </div>
        </div>
        <div className="flex justify-center items-center">
        <Image src={joker} alt="abc" width={250} height={250} className="-mt-5 lg:-mt-10 relative z-50"/>
