...
function About() {
  return (
    <div className="main-about">
      <div>
        <p className="text-center font-semibold text-2xl">About</p>
        <p className="text-center font-semibold text-4xl">We Meme Business!</p>
        <div className="bg-about">
          ...
          <div className="py-5 px-5 md:py-8 md:px-12 bg-white rounded-3xl ">
              <h1 className="text-center font-bold text-4xl text-black">Roadmap</h1>
